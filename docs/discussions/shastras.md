...
- **An honorific outside the title** – written separately and not italicized when the rest is italicized: *Shri Harililamrut* (where *Harililamrut* would be the title proper)?
...
Propose a citation format via [Feedback](../feedback.md) – use a subject like *Shastras: …*.
