...
The web question is whether digital publications follow that print default (BrE-by-default, AmE if the source author is American), or whether the web should pick **one** variety and apply it consistently regardless of author origin.
