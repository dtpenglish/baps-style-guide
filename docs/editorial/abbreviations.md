...
## 3.12.3 Capitalization by Length
...
## 3.12.4 Articles before Acronyms and Initialisms
...
## 3.12.5 First Mention — Spell Out, Then Abbreviate
...
## 3.12.6 Plurals of Abbreviations
...
## 3.12.7 Commas with *i.e.*, *e.g.*, and *etc.*
...
## 3.12.8 See Also
- [3.14 Apostrophes & Possessives](apostrophes.md) — apostrophes in plurals of single letters and degrees.
- [3.10 Punctuation](punctuation.md) — comma rules referenced here.
