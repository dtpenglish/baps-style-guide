...
Our editorial voice is **clear, respectful, and serviceable**. We write to convey meaning, not to impress. We use plain English where plain English suffices, and reach for specialised vocabulary only when it earns its place.

## Suggested principles (to be discussed)
