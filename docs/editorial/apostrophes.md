...
## 3.14.3 Exceptions — Plural-Form Names and Uninflected Nouns
...
## 3.14.4 Plurals of Abbreviations and Single Letters
- **Multi-letter abbreviations** — *no* apostrophe (*CDs*, *NGOs*, *MEPs*, *PhDs*, *1920s*). See [3.12.6 Plurals of Abbreviations](abbreviations.md#3126-plurals-of-abbreviations).
- **Single letters** — *use* an apostrophe for clarity, since the bare *s* could be misread:
  - mind your **p's** and **q's**
  - cross your **t's** and dot your **i's**
  - she earned all **A's**

## 3.14.5 Possessive vs. Attributive in Names and Titles
...
## 3.14.7 What an Apostrophe Doesn't Do
