...
For comma rules around *such as* introducing examples within prose (not a vertical list), see [3.10.6 Commas with *such as* and *like*](punctuation.md#3106-commas-with-such-as-and-like).
