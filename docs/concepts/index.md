...
A handful of technical terms from linguistics underpin the rest of this guide. Understanding them prevents confusion when rules pull in different directions — for example, when the same word is *anglicised* in one place but *transliterated* in another, the reasons follow from these definitions.
...
!!! tip "Why this matters editorially"
    If a word appears in the OED, it is anglicised: spell it as the OED spells it, do not italicise it, do not add diacritics. *Dharma*, *dal*, *puri* are anglicised — so they're set in roman, not italic. See the [Translation & Transliteration Guide](../translation/index.md).
...
## How these terms relate in our work

| Process | What changes | Reader gains |
|---|---|---|
| **Translation** | Words and grammar | Meaning |
| **Transliteration** | Script only | Pronunciation |
| **Romanization** | Script → Roman alphabet | Approximate pronunciation in a familiar script |
| **Anglicization** | Spelling, often pronunciation | Word becomes part of English |

A typical SAP page may contain all four at once: a translated narrative (translation), with embedded *italicised non-English terms* (transliteration / romanization) and a few *dharma*, *guru*, *yoga* (anglicization).

## Where these rules apply

- [Translation & Transliteration Guide](../translation/index.md) — the rules that flow from these concepts (when to translate, when to transliterate, when to use the OED spelling).
- [Editorial — Italics](../editorial/italics.md) — the formatting consequence (italicise transliterations, leave anglicised words in roman).
- [Diacritics & Transliteration](../diacritics/index.md) — how we render long vowels and unfamiliar consonants in transliteration.
