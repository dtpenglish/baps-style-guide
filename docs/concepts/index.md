...
## 1.5 How These Terms Relate in Our Work
...
A typical SAP page may contain all four at once: a translated narrative (translation), with embedded *italicized non-English terms* (transliteration / romanization) and a few *dharma*, *guru*, *yoga* (anglicization).

## 1.6 Where These Rules Apply
...
- [Editorial – Italics](../editorial/italics.md) – the formatting consequence (italicize transliterations, leave anglicized words in roman).
